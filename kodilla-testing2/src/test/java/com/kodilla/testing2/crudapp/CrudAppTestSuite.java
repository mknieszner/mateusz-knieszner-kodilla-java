...
/**
 * Crud App Selenium Test Suite.
 */
public class CrudAppTestSuite {
  private static final String BASE_URL = "https://mknieszner.github.io/";
  ...
  private void deleteTask(final String taskName) throws InterruptedException {
    ...
    driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
        ...
        .forEach(theForm -> {
          ...
          final WebElement buttonDeleteTask = theForm.findElement(By.xpath(".//button[4]"));
  ...
  private boolean checkTaskExistsInTrello(final String taskName) throws InterruptedException {
    ...
    result = driverTrello.findElements(By.xpath("//span[contains(@class, \"js-card-name\")]")).stream()
  ...
  private void sendTaskToTrello(final String taskName) throws InterruptedException {
    driver.navigate().refresh();
    ...
    driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
        ...
        .forEach(theForm -> {
          ...
          final WebElement buttonCreateCard = theForm.findElement(By.xpath(".//button[contains(@class, \"card-creation\")]"));
  ...
  private String createCrudAppTestTask() throws InterruptedException {
    final String XPATH_TASK_NAME = "//form[contains(@action,\"heroku\")]/fieldset[1]/input";
    final String XPATH_TASK_CONTENT = "//form[contains(@action,\"heroku\")]/fieldset[2]/textarea";
    final String XPATH_ADD_BUTTON = "//form[contains(@action,\"heroku\")]/fieldset[3]/button";
