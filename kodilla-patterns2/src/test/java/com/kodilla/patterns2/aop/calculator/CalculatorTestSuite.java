...
public class CalculatorTestSuite {
  ...
  public void testAdd() {
    //Given
    //When
    final double result = calculator.add(10, 15);
    //Then
  ...
  public void testSub() {
    //Given
    //When
    final double result = calculator.sub(10, 15);
    //Then
  ...
  public void testMul() {
    //Given
    //When
    final double result = calculator.mul(10, 15);
    //Then
  ...
  public void testDiv() {
    //Given
    //When
    final double result = calculator.div(15, 5);
    //Then
  ...
  public void testFactorial() {
    //Given
    //When
    final BigDecimal result = calculator.factorial(new BigDecimal(1000));
    //Then
